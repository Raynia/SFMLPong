...
int main()
{
	...
	rightPlayer.setSize(rightPlayerSize);
	rightPlayer.setPosition(rightPlayerPosition);
	...
	while (window.isOpen())
	{
		...
		{
			Player1.StickVerticalMove(VerticalDirection::Up, DeltaTime);
		}
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Down))
		{
			Player1.StickVerticalMove(VerticalDirection::Down, DeltaTime);
		}
